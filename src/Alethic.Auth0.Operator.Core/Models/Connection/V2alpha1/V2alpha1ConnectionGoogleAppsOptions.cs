...
namespace Alethic.Auth0.Operator.Core.Models.Connection.V2alpha1
{
    ...
    /// </summary>
    public record V2alpha1ConnectionGoogleAppsOptions : V2alpha1ConnectionSocialOptions
    {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public V2alpha1ConnectionGoogleAppsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
