...
public record V2alpha1ConnectionOptionsOkta
{
    [JsonPropertyName("attribute_map")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha1ConnectionAttributeMapOkta? AttributeMap { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha1ConnectionTypeEnumOkta? Type { get; set; }
