...
namespace Alethic.Auth0.Operator.Core.Models.Connection.V2alpha1
{
    ...
    /// <summary>
    /// Configuration options for a generic <c>oidc</c> (OpenID Connect) connection strategy.
    /// </summary>
    public record V2alpha1ConnectionOidcOptions : V2alpha1ConnectionOptionsClientCredentials
    {

        /// <summary>
        /// OpenID Connect discovery document URL (e.g. <c>https://idp.example.com/.well-known/openid-configuration</c>). When provided, other endpoint fields are populated automatically.
        /// </summary>
        ...
        /// <summary>
        /// UserInfo endpoint URL of the identity provider.
        /// </summary>
        ...
        /// <summary>
        /// JWKS (JSON Web Key Set) URI of the identity provider used to verify ID token signatures.
        /// </summary>
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public V2alpha1ConnectionOptionsAttributeMap? AttributeMap { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public V2alpha1ConnectionOptionsConnectionSettings? ConnectionSettings { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public V2alpha1ConnectionOptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
