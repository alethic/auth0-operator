...
public record V2alpha1ConnectionOptionsAuth0
{
    [JsonPropertyName("attributes")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha1ConnectionAttributes? Attributes { get; set; }

    [JsonPropertyName("authentication_methods")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha1ConnectionAuthenticationMethods? AuthenticationMethods { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha1ConnectionCustomScripts? CustomScripts { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha1ConnectionMfa? Mfa { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha1ConnectionPasswordPolicyEnum? PasswordPolicy { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha1ConnectionIdentifierPrecedenceEnum[]? Precedence { get; set; }
