...
namespace Alethic.Auth0.Operator.Core.Models.Connection.V2alpha3
{
    ...
    /// </summary>
    public record V2alpha3ConnectionConf
    {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public V2alpha3ConnectionStrategy? Strategy { get; set; }

        /// <summary>
        /// Provisioning ticket URL used for enterprise connections during setup.
        /// </summary>
        [JsonPropertyName("provisioningTicketUrl")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        ...
        /// </summary>
        [JsonPropertyName("enabledClients")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        ...
        /// </summary>
        [JsonPropertyName("isDomainConnection")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
