...
namespace Alethic.Auth0.Operator.Core.Models.Connection.V2alpha3
{
    ...
    /// </summary>
    public record V2alpha3ConnectionOptionsAssertionDecryptionSettings
    {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public V2alpha3ConnectionAssertionDecryptionAlgorithmProfile? DecryptionAlgorithm { get; set; }
