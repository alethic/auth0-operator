...
public record V2alpha3ConnectionOptionsOidc
{

    [JsonPropertyName("attributeMap")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha3ConnectionAttributeMapOidc? AttributeMap { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public V2alpha3ConnectionTypeEnumOidc? Type { get; set; }
