...
namespace Alethic.Auth0.Operator.Core.Models.Connection.V2alpha3
{
    ...
    public enum V2alpha3ConnectionStrategy
    {
        ...
        [JsonStringEnumMemberName("auth0Oidc")]
        Auth0Oidc,
        ...
        [JsonStringEnumMemberName("evernoteSandbox")]
        EvernoteSandbox,
        ...
        [JsonStringEnumMemberName("googleApps")]
        GoogleApps,

        /// <summary>Google OAuth2 social connection.</summary>
        [JsonStringEnumMemberName("googleOauth2")]
        GoogleOAuth2,
        ...
        [JsonStringEnumMemberName("paypalSandbox")]
        PaypalSandbox,
        ...
        [JsonStringEnumMemberName("salesforceCommunity")]
        SalesforceCommunity,

        /// <summary>Salesforce sandbox social connection.</summary>
        [JsonStringEnumMemberName("salesforceSandbox")]
        SalesforceSandbox,
