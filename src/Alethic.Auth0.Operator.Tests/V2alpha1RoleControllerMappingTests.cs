...
namespace Alethic.Auth0.Operator.Tests
{
    ...
    [TestClass]
    public class V2alpha1RoleControllerMappingTests
    {
        ...
        {
            Assert.IsNull(V2alpha1RoleController.FromApi(null, null));
        }
        ...
        public void FromApi_Role_MapsScalarProperties()
        {
            ...
            var result = V2alpha1RoleController.FromApi(source, null);
        ...
        public void FromApi_Role_MapsPermissions()
        {
            ...
            var result = V2alpha1RoleController.FromApi(source, permissions);
        ...
        {
            var result = V2alpha1RoleController.FromApi(new PermissionsResponsePayload
            {
        ...
        {
            var conf = new V2alpha1RoleConf { Name = "admin", Description = "Administrator role" };
            var req = new CreateRoleRequestContent { Name = "placeholder" };
            V2alpha1RoleController.ApplyToApi(conf, req);
        ...
        {
            var conf = new V2alpha1RoleConf { Name = "admin", Description = null };
            var req = new CreateRoleRequestContent { Name = "placeholder" };
            V2alpha1RoleController.ApplyToApi(conf, req);
        ...
        public void Roundtrip_Permissions_PreservesValues()
        {
            ...
            var conf = V2alpha1RoleController.FromApi(source, permissions);
            Assert.IsNotNull(conf);

            var createReq = new CreateRoleRequestContent { Name = "placeholder" };
            V2alpha1RoleController.ApplyToApi(conf, createReq);
