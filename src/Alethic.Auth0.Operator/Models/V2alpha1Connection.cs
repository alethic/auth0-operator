...
namespace Alethic.Auth0.Operator.Models
{
        ...
        V1TenantEntityInstance<V2alpha1Connection.SpecDef, V2alpha1Connection.StatusDef, V2alpha1ConnectionConf, V2alpha1ConnectionConf>
    {
        ...
        public class SpecDef : V1TenantEntityInstanceSpec<V2alpha1ConnectionConf>
        {
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'auth0-oidc' ? true : !has(self.options) || !has(self.options.auth0Oidc)", message: "options.auth0Oidc must only be set when strategy is 'auth0-oidc'")]
            [ValidationRule("!has(self.strategy) || self.strategy == 'waad' ? true : !has(self.options) || !has(self.options.azureAd)", message: "options.azureAd must only be set when strategy is 'waad'")]
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'evernote-sandbox' ? true : !has(self.options) || !has(self.options.evernoteSandbox)", message: "options.evernoteSandbox must only be set when strategy is 'evernote-sandbox'")]
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'google-apps' ? true : !has(self.options) || !has(self.options.googleApps)", message: "options.googleApps must only be set when strategy is 'google-apps'")]
            [ValidationRule("!has(self.strategy) || self.strategy == 'google-oauth2' ? true : !has(self.options) || !has(self.options.googleOAuth2)", message: "options.googleOAuth2 must only be set when strategy is 'google-oauth2'")]
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'paypal-sandbox' ? true : !has(self.options) || !has(self.options.paypalSandbox)", message: "options.paypalSandbox must only be set when strategy is 'paypal-sandbox'")]
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'salesforce-community' ? true : !has(self.options) || !has(self.options.salesforceCommunity)", message: "options.salesforceCommunity must only be set when strategy is 'salesforce-community'")]
            [ValidationRule("!has(self.strategy) || self.strategy == 'salesforce-sandbox' ? true : !has(self.options) || !has(self.options.salesforceSandbox)", message: "options.salesforceSandbox must only be set when strategy is 'salesforce-sandbox'")]
            [ValidationRule("!has(self.strategy) || self.strategy == 'samlp' ? true : !has(self.options) || !has(self.options.saml)", message: "options.saml must only be set when strategy is 'samlp'")]
