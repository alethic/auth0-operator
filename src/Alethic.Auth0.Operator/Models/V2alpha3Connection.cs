...
namespace Alethic.Auth0.Operator.Models
{
        ...
        V1TenantEntityInstance<V2alpha3Connection.SpecDef, V2alpha3Connection.StatusDef, V2alpha3ConnectionConf, V2alpha3ConnectionConf>
    {
        ...
        public class SpecDef : V1TenantEntityInstanceSpec<V2alpha3ConnectionConf>
        {
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'auth0-oidc' ? true : !has(self.options) || !has(self.options.auth0__dash__oidc)", message: "options.auth0-oidc must only be set when strategy is 'auth0-oidc'")]
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'evernote-sandbox' ? true : !has(self.options) || !has(self.options.evernote__dash__sandbox)", message: "options.evernote-sandbox must only be set when strategy is 'evernote-sandbox'")]
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'google-apps' ? true : !has(self.options) || !has(self.options.google__dash__apps)", message: "options.google-apps must only be set when strategy is 'google-apps'")]
            [ValidationRule("!has(self.strategy) || self.strategy == 'google-oauth2' ? true : !has(self.options) || !has(self.options.google__dash__oauth2)", message: "options.google-oauth2 must only be set when strategy is 'google-oauth2'")]
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'paypal-sandbox' ? true : !has(self.options) || !has(self.options.paypal__dash__sandbox)", message: "options.paypal-sandbox must only be set when strategy is 'paypal-sandbox'")]
            ...
            [ValidationRule("!has(self.strategy) || self.strategy == 'salesforce-community' ? true : !has(self.options) || !has(self.options.salesforce__dash__community)", message: "options.salesforce-community must only be set when strategy is 'salesforce-community'")]
            [ValidationRule("!has(self.strategy) || self.strategy == 'salesforce-sandbox' ? true : !has(self.options) || !has(self.options.salesforce__dash__sandbox)", message: "options.salesforce-sandbox must only be set when strategy is 'salesforce-sandbox'")]
