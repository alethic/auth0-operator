...
namespace Alethic.Auth0.Operator.Controllers
{
    ...
    [EntityRbac(typeof(V2alpha1Role), Verbs = RbacVerb.All)]
    ...
    public class V2alpha1RoleController :
        V1TenantEntityInstanceController<V2alpha1Role, V2alpha1Role.SpecDef, V2alpha1Role.StatusDef, V2alpha1RoleConf, V2alpha1RoleConf>,
        IEntityController<V2alpha1Role>
    {

        /// <summary>
        /// Transforms the Auth0 Management API role model and its associated permissions to the operator's role configuration model.
        /// Note: <see cref="V2alpha1RolePermission.ResourceServerRef"/> is populated with the resource server identifier only; it cannot
        /// be correlated back to a specific operator-managed resource.
        /// </summary>
        [return: NotNullIfNotNull(nameof(source))]
        internal static V2alpha1RoleConf? FromApi(GetRoleResponseContent? source, IEnumerable<PermissionsResponsePayload>? permissions) => source is null ? null : new()
        {
            Name = source.Name,
        ...
        /// </summary>
        internal static V2alpha1RolePermission FromApi(PermissionsResponsePayload source) => new()
        {
        ...
        /// </summary>
        internal static void ApplyToApi(V2alpha1RoleConf conf, CreateRoleRequestContent request)
        {
        ...
        /// </summary>
        internal static void ApplyToApi(V2alpha1RoleConf conf, UpdateRoleRequestContent request)
        {
            if (conf.Name is not null)
                request.Name = conf.Name;
        ...
        public V2alpha1RoleController(IKubernetesClient kube, IMemoryCache cache, IOptions<OperatorOptions> options, ILogger<V2alpha1RoleController> logger) :
        ...
        /// <inheritdoc />
        protected override async Task<V2alpha1RoleConf?> Get(IManagementApiClient api, string id, string defaultNamespace, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc />
        protected override async Task<string?> Find(IManagementApiClient api, V2alpha1Role entity, V2alpha1Role.SpecDef spec, string defaultNamespace, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc />
        protected override string? ValidateCreate(V2alpha1RoleConf conf)
        {
            if (string.IsNullOrWhiteSpace(conf.Name))
        ...
        /// <inheritdoc />
        protected override async Task<string> Create(IManagementApiClient api, V2alpha1RoleConf conf, string defaultNamespace, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc />
        protected override async Task Update(IManagementApiClient api, string id, V2alpha1RoleConf? last, V2alpha1RoleConf conf, string defaultNamespace, CancellationToken cancellationToken)
        {
        ...
        async Task ApplyPermissions(IManagementApiClient api, string id, V2alpha1RoleConf? last, V2alpha1RoleConf conf, string defaultNamespace, CancellationToken cancellationToken)
        {
