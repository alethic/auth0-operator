...
namespace Alethic.Auth0.Operator.Controllers
{
        ...
        IEntityController<V2alpha3CustomText>
    {
        ...
        public V2alpha3CustomTextController(IKubernetesClient kube, IMemoryCache cache, IOptions<OperatorOptions> options, ILogger<V2alpha3CustomTextController> logger) :
