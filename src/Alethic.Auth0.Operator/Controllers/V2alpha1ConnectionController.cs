...
namespace Alethic.Auth0.Operator.Controllers
{
        ...
        IEntityController<V2alpha1Connection>
    {
        ...
        internal static Optional<Dictionary<string, ConnectionUpstreamAdditionalProperties?>?> ToApiUpstreamParams(Dictionary<string, V2alpha1ConnectionUpstreamParam?>? source)
        {
            if (source is null)
                return default;
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        internal static object? ResolveStrategyOptions(string? strategy, V2alpha1ConnectionOptions? options) => strategy switch
        {
