...
namespace Alethic.Auth0.Operator.Controllers
{
        ...
        IEntityController<V2alpha3ClientGrant>
    {
        ...
        public V2alpha3ClientGrantController(IKubernetesClient kube, IMemoryCache cache, IOptions<OperatorOptions> options, ILogger<V2alpha3ClientGrantController> logger) :
