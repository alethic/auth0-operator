...
namespace Alethic.Auth0.Operator.Controllers
{
        ...
        where TLastConf : class
    {
        ...
        public V1TenantEntityController(IKubernetesClient kube, IMemoryCache cache, IOptions<OperatorOptions> options, Auth0HttpClientProvider httpClientProvider, ILogger logger) :
