...
namespace Alethic.Auth0.Operator.Controllers
{
        ...
        IEntityController<V1alpha1CustomDomain>
    {
        ...
        static CustomDomainProvisioningTypeEnum ToApi(V1alpha1CustomDomainCertificateProvisioning value) => value switch
        {
            V1alpha1CustomDomainCertificateProvisioning.Auth0ManagedCertificate => CustomDomainProvisioningTypeEnum.Auth0ManagedCerts,
            V1alpha1CustomDomainCertificateProvisioning.SelfManagedCertificate => CustomDomainProvisioningTypeEnum.SelfManagedCerts,
        ...
        /// <returns></returns>
        static CreateCustomDomainRequestContent ToCreateRequest(V1alpha1CustomDomainConf source) => new()
        {
        ...
        static void ApplyToApi(V1alpha1CustomDomainConf? source, UpdateCustomDomainRequestContent target)
        {
            if (source is null)
                return;
        ...
        /// <returns></returns>
        /// <exception cref="InvalidOperationException"></exception>
        static V1alpha1CustomDomainCertificateProvisioning? FromApi(CustomDomainTypeEnum? value) => value?.Value switch
        {
            CustomDomainTypeEnum.Values.Auth0ManagedCerts => V1alpha1CustomDomainCertificateProvisioning.Auth0ManagedCertificate,
            CustomDomainTypeEnum.Values.SelfManagedCerts => V1alpha1CustomDomainCertificateProvisioning.SelfManagedCertificate,
            null => null,
            _ => throw new InvalidOperationException()
        };
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        static V1alpha1CustomDomainConf FromApi(GetCustomDomainResponseContent source) => new()
        {
